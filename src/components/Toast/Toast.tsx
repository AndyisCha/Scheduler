  ...
  return (
    ...
    >
        ...
        {toast.action && (
          <div className="mt-3">
            <button
              ...
              className="inline-flex items-center px-3 py-1 rounded-md text-xs font-medium bg-white bg-opacity-50 hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-current transition-colors"
            >
              {toast.action.label}
            </button>
          </div>
      ...
      <div className="flex-shrink-0 ml-3">
        <button
          onClick={handleHide}
          className="inline-flex items-center justify-center w-5 h-5 rounded-full hover:bg-black hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-current transition-colors"
          aria-label="토스트 닫기"
        >
